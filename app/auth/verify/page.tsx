  ...
  useEffect(() => {
    ...
    const verify = async () => {
      ...
      try {
        ...
        if (res.ok) {
          const successText = (data?.message as string | undefined) || t("verify.success.subtitle")
          setSuccessMessage(successText)
          setStatus("success")
          setTimeout(() => router.push("/auth/login"), 5000)
        } else {
          const errorText = (data?.message as string | undefined) || (data?.error as string | undefined) || t("verify.error.subtitle")
        ...
        return (
          <>
            ...
            <p className="text-center text-sm text-muted-foreground">
              {successMessage || t("verify.success.subtitle")}
            </p>
